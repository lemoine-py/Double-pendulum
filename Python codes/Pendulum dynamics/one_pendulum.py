...
def solve_RK4(f, u0, dt, N):
    """ Solves the differential equation using the Runge-Kutta 4 method """
...
ani.save('one_pendulum.gif',writer='pillow',fps=1/dt) # Save the animation as a gif