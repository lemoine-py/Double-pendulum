...
print(f"Lambda_max(t_max) = {lya_a[-1]}")
print(f"Lambda_max(t=20) = {lya_a[2000]}") # t = 20 if dt = 0.01
print(f"Lyapunov array average from t=20 to t_max: {np.average(lya_a[2000:N])}")
print()
